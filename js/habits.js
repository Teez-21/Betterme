...
const Habits = {
  ...
  render() {
    ...
    if (ringWrap) ringWrap.innerHTML = Utils.ringSVG(pct, 26).replace('viewBox="0 0 34 34"', 'viewBox="0 0 62 62"').replace(/cx="17" cy="17"/g, 'cx="31" cy="31"');
  ...
  renderHabitItem(habit, iso) {
    ...
    const typeMeta = { sino: '✅', contador: '🔢', tiempo: '⏱️', numerico: '📊' };
    const item = Utils.el(`
      <div class="habit-item ${done ? 'completed' : ''}" style="--habit-color:${habit.color}">
        ...
        <div class="habit-name-wrap" data-role="open">
          ...
          <div class="habit-meta">
            <span class="habit-type-badge">${typeMeta[habit.tipo]} ${this.typeLabel(habit)}</span>
