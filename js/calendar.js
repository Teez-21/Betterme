...
const Calendar = {
  ...
  renderMonthGrid() {
    ...
    for (let i = 0; i < totalCells; i++) {
      ...
      if (this.filters.proyecto && this.projectsOnDate(iso).length) dots.push(CAL_TYPE_META.proyecto.dot);
    ...
    const wrap = Utils.el(`
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          <button class="btn btn-secondary btn-block" data-t="evento">📅 Evento</button>
          <button class="btn btn-secondary btn-block" data-t="cumpleanos">🎂 Cumpleaños</button>
          <button class="btn btn-secondary btn-block" data-t="proyecto">📁 Proyecto</button>
          <button class="btn btn-secondary btn-block" data-t="otro">📌 Otro</button>
        </div>
      </div>
    `);
